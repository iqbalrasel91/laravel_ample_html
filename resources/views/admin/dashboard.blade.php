                                            ...
                                            <table class="table no-wrap">
                                                ...
                                                <tbody>
                                                    <tr class="advanced-table active">
                                                        ...
                                                        <td>
                                                            <img src="{!! asset('admin_assets/images/users/1.jpg') !!}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Andrew Simons</td>
                                                        <td>Modulator</td>
                                                        <td>6 May 2016</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{!! asset('admin_assets/images/users/2.jpg') !!}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Hanna Gover</td>
                                                        <td>Admin </td>
                                                        <td>13 Jan 2005</td>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{!! asset('admin_assets/images/users/3.jpg') !!}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Nirav</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2001</td>
                                            ...
                                            <table class="table no-wrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="advanced-table">
                                                        ...
                                                        <td>
                                                            <img src="{!! asset('admin_assets/images/users/4.jpg') !!}" class="rounded-circle" width="30">
                                                        </td>
                                                        <td>Joshi Sunil</td>
                                                        <td>Admin</td>
                                                        <td>21 Mar 2004</td>
