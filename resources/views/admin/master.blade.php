...
<head>
    ...
    <link href="{!! asset('admin_assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css') !!}" rel="stylesheet">
    <!--c3 CSS -->
...
<body>
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{!! asset('admin_assets/images/logos/logo-icon.png') !!}" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{!! asset('admin_assets/images/logos/logo-light-icon.png') !!}" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{!! asset('admin_assets/images/logos/logo-text.png') !!}" alt="homepage" class="dark-logo" />
                             <!-- Light Logo text -->    
                             <img src="{!! asset('admin_assets/images/logos/logo-light-text.png') !!}" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{!! asset('admin_assets/images/users/1.jpg') !!}" alt="user" class="rounded-circle"> <span class="profile-status online pull-right"></span> </span>
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{!! asset('admin_assets/images/users/2.jpg') !!}" alt="user" class="rounded-circle"> <span class="profile-status busy pull-right"></span> </span>
                                                <span class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{!! asset('admin_assets/images/users/3.jpg') !!}" alt="user" class="rounded-circle"> <span class="profile-status away pull-right"></span> </span>
                                                <span class="mail-contnet">
                                                    <h5 class="message-title">Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </span>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img"> <img src="{!! asset('admin_assets/images/users/4.jpg') !!}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                                <span class="mail-contnet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container p-0"> <img class="d-block img-fluid" src="{!! asset('admin_assets/images/images/big/img1.jpg') !!}" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0"><img class="d-block img-fluid" src="{!! asset('admin_assets/images/big/img2.jpg') !!}" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0"><img class="d-block img-fluid" src="{!! asset('admin_assets/images/big/img3.jpg"') !!}" alt="Third slide"></div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                                    <div class=""><img src="{!! asset('admin_assets/images/users/1.jpg') !!}" alt="user" class="rounded" width="80"></div>
                                    <div class="ml-2">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile text-center dropdown p-3">
                                <div class="user-pic"><img src="{!! asset('admin_assets/images/users/1.jpg') !!}" alt="users" class="rounded-circle" width="50" /></div>
    ...
    <script src="{!! asset('admin_assets/dist/js/app.init.minimal.js') !!}"></script>
    ...
    <script src="{!! asset('admin_assets/dist/js/pages/chartist/chartist-plugin-tooltip.js') !!}"></script>
    ...
    <script src="{!! asset('admin_assets/dist/js/pages/calendar/cal-init.js') !!}"></script>
    <script>
